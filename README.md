...
$\partial_t B_\theta\right + \nabla\!\cdot(B_\theta\right \mathbf{v}_{rz}) + \frac{v_r}{r} B_{\theta} = \eta$
$\left[\frac{1}{r}\partial_r\!\left(r\,\partial_r B_\theta\right) - \frac{B_\theta}{r^2} + \partial_{zz} B_\theta\right]$
